            ...
            <div key={task.id} className="flex items-center space-x-4 mb-4">
              <div className="flex flex-col sm:flex-row bg-white rounded-lg shadow-xl p-4 w-full justify-between items-start sm:items-center">
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="flex flex-col sm:flex-row text-xs space-x-2">
                        ...
                        <span className={`px-2 py-1 my-4 rounded-full text-center lg:m-0 ${task.status === 'high' ? 'bg-red-100 text-red-500' : 'bg-green-100 text-green-600'}`}>
                          {task.status}
                        </span>
                      </div>
                    </div>
                ...
                <div className="flex items-center space-x-4">
                  <span className={`flex font-semibold bg-green-100 text-green-600 px-2 py-1 rounded-full ${task.timeSpent === '00:15:00' ? 'bg-red-100 text-red-500' : 'bg-green-100 text-green-600'}`}>
                  ...
                  <img src={Tasks} alt="tasks icon" className="w-5 h-5 cursor-pointer" />
                  </span>
