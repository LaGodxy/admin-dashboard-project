...
import verticalDropdown from "../assets/icons/verticalDropdown.svg";
import { FaArrowRightLong } from 'react-icons/fa6';
import { useState } from 'react';

const ProjectAddodleIcon = () => {
            ...
            <div key={task.id} className="flex items-center space-x-4 mb-4">
              <div className="flex flex-col sm:flex-row bg-white rounded-lg shadow-xl p-4 w-full justify-between items-start sm:items-center">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <img src={verticalDropdown} alt="dropdown icon" className="w-5 h-5 cursor-pointer" /> {hoveredStatus && (
                    <div className="absolute right-0 top-24 bg-red-300 text-white text-xs rounded-lg py-1 px-2 mr-6">
...
export default ProjectAddodleIcon;
