        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="relative bg-white rounded-lg shadow-lg max-w-4xl w-full p-6">
            ...
            <div className="flex flex-col space-y-4 md:space-y-6">
              ...
              {/* Description */}
              <div className="space-y-2 border-t-0 border-l-0 border-r-0 border-b-gray-300 border-b-2 pb-8">
...
TaskModal.propTypes = {
  onClose: PropTypes.string.isRequired, // Make sure routes is an array of strings
};
